...
namespace boost
{
...
#if (defined(__BORLANDC__) || defined(__CODEGEAR__)) && !defined(__clang__) && defined(BOOST_NO_INTEGRAL_INT64_T)
  ...
  struct uint_value_t 
  {
#if (defined(__BORLANDC__) || defined(__CODEGEAR__)) && !defined(__clang__)
     // It's really not clear why this workaround should be needed... shrug I guess!  JM
