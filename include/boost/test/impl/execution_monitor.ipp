...
#  if defined(__BORLANDC__) && __BORLANDC__ >= 0x560 && !defined(__clang__) || defined(__MWERKS__)
#    include <stdint.h>
#  endif
...
{
#if (defined(__BORLANDC__) && !defined(BOOST_EMBTC)) || \
    defined(BOOST_EMBTC_WIN32C)
    // Functions "_controlfp/_control87" and "_clearfp/_clear87"
    // are not supported in bcc64
    if( !on_off )
        _clearfp();
...
#endif /* (__BORLANDC__ && !BOOST_EMBTC) || BOOST_EMBTC_WIN32C */
}
