...
#if defined(BOOST_MSVC) || (defined(__BORLANDC__) && !defined(__clang__) && !defined(BOOST_DISABLE_WIN32))
...
//
#if defined(_MSC_EXTENSIONS) && (!defined(__BORLANDC__)/* || defined(__clang__)*/)
#  define BOOST_TT_TEST_MS_FUNC_SIGS
#endif
