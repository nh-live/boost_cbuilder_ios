...
#  elif defined(__BORLANDC__) && defined(__clang__) && defined(_WIN32)
      // Embarcadero LLVM/Clang based compilers for Windows
      // NOTE: BOOST_EMBTC_* macros are not available yet, since header
      //       "boost/tr1/detail/config.hpp" is included at the end of this
      //       file, which includes "boost/config.hpp" at the end. So, header
      //       "boost/config/compiler/clang.hpp" is not included at this point.
#     define BOOST_TR1_STD_HEADER(name) <../include/dinkumware64/name>
