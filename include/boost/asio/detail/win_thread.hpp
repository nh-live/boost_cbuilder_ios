...
BOOST_ASIO_DECL void apc_function(ULONG_PTR data);
# else
BOOST_ASIO_DECL void __stdcall apc_function(ULONG_PTR data);
# endif /* defined(__BORLANDC__) && defined(__clang__) && defined(_WIN64) */
#endif
...
#else
# if defined(__BORLANDC__) && defined(__clang__) && defined(_WIN64)
  friend BOOST_ASIO_DECL void apc_function(ULONG_PTR);
# else
