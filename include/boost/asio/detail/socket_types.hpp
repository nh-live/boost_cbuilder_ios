...
#  elif defined(_MSC_VER) || defined(__BORLANDC__)
    // Embarcadero bcc64 LLVM/Clang based
#   if defined(__clang__)
     // bcc64 will call ilink64, which automatically select the proper extension
#    pragma comment(lib, "ws2_32")
//#  pragma comment(lib, "mswsock") // These symbols are inside import64.a
#   else
